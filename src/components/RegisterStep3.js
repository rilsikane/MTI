        ...
        return(
            <View style={styles.registerStep1ContainerStyle}>
                <View style={styles.registerDirectionContainerStyle}>
                    ...
                    <Text style={styles.directionTextStyle}>กรุณากรอกข้อมูลบัญชีส่วนตัว เพื่อใช้ในการเข้าใช้งานแอปพลิเคชั่น</Text>
                </View>
                ...
                >
                    <View style={styles.userDetailContainerStyle}>
                        ...
                        <Text style={styles.directionTextStyle}>กำหนดรหัสผ่านต้องมีอักขระอย่างน้อย 8 ตัว และประกอบไปด้วย{'\n'}ตัวอักษรภาษาอังกฤษ พิมพ์เล็ก พิมพ์ใหญ่ และตัวเลข</Text>
